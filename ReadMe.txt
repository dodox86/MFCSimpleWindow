================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: MFCSimpleWindow プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した MFCSimpleWindow には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには MFCSimpleWindow アプリケーションを構成している各ファイ
ルの概要説明が含まれます。

MFCSimpleWindow.vcxproj
...
MFCSimpleWindow.vcxproj.filters
...
MFCSimpleWindow.h
   ...
   CMFCSimpleWindowApp アプリケーション クラスを宣言します。

MFCSimpleWindow.cpp
   これは、アプリケーション クラス CMFCSimpleWindowApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\MFCSimpleWindow.ico
   これは、アプリケーションのアイコンとして使用されるアイコンファイルです。この
   アイコンはメイン リソース ファイル MFCSimpleWindow.rc に含まれていま
   す。

res\MFCSimpleWindow.rc2
...
StdAfx.h, StdAfx.cpp
   ...
   MFCSimpleWindow.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
